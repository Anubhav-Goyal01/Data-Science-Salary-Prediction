...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            metric_info:MetricInfoArtifact = evaluate_regression_model(models_list=model_list,X_train=x_train,y_train=y_train,X_test=x_test,y_test=y_test,base_accuracy=base_accuracy)
            ...
            housing_model = LaptopPriceEstimator(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
